...
export default function Header() {
  return (
    <Head>
      ...
      />
      <meta property="og:title" content="Albert Studios | Consultant" />
      <meta property="title" content="Albert Studios | Consultant" />
      <meta property="og:url" content="https://albertstudios.dev/" />
      <meta property="url" content="https://albertstudios.dev/" />
      <meta property="og:site_name" content="Albert Studios" />
      <meta
